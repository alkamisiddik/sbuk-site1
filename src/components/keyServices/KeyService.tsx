...
const cards = [
    ...
    },
    {
        ...
        details: "We empower businesses to expand into international markets with comprehensive export development solutions. From market research to financial support, we provide the tools, strategies, and guidance needed to make your exports successful and sustainable.",
        boxDetails: [
            {
    ...
    },
    {
        ...
        details: "We provide businesses with expert advisory and up-to-date trade information to help them navigate complex markets, comply with regulations, and make informed decisions. Our advisory services are designed to reduce risks, identify opportunities, and support sustainable trade growth.",
        boxDetails: [
            {
